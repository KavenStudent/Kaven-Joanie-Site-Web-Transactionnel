...
--
-- Hôte : 127.0.0.1
-- Généré le :  ven. 29 oct. 2021 à 01:40
...
CREATE TABLE `films` (
  ...
  `bandeAnnonce` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
  `prix` float NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
