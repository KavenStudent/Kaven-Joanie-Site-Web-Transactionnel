					...
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						...
						<li class="nav-item">
							<a class="nav-link" href="" data-bs-toggle="modal"
								data-bs-target="#modal-Connexion">Connexion</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="serveur/listerFilm.php">Lister membre</a>
						</li>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<form class="formMembre" id="formMembre" action="serveur/enregistrerMembre.php"
									method="POST" onSubmit="return valider()">
									<div class="myInput">
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<form class="form-connexion" id="form-connexion" action="serveur/connexion.php"
									method="POST">
									<div class="myInput">
										<label for="pages" class="form-label">Courriel</label>
									...
									<div class="myInput">
										<label for="password" class="form-label">Mot de passe</label>
										<input type="password" class="form-control" id="passwordConnexion" name="password"
											required>
